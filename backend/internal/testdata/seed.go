...
func SeedTestData(ctx context.Context, db Execer) (*TestData, error) {
	...
	// Owner 1 - Venue 1: Beth El Synagogue
	...
	// Owner 1 - Venue 2: Community Center
	...
	// Event List 3 for Venue 3: Weekly Schedule - PRIVATE
