...
<div class="bg-white rounded-xl shadow-lg pt-4 px-8 pb-8 md:pt-12 md:px-12 md:pb-12 text-[12px] md:text-base">
  ...
  <div class="space-y-6 text-gray-700 leading-relaxed max-w-4xl mx-auto">
    <p class="text-[14px] md:text-lg text-center">
      times.place is a venue management and event scheduling platform designed to help venues share
    ...
    <p>
      times.place organizes information in a hierarchical structure:
    </p>
    ...
    <div class="my-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
      <div class="flex flex-col items-center space-y-4">
        <!-- Owner -->
        <div class="bg-blue-100 border-2 border-blue-300 rounded-lg px-6 py-4 text-center min-w-[200px]">
          <div class="font-bold text-[14px] md:text-lg text-blue-900">Owner</div>
          <div class="text-[10px] md:text-sm text-blue-700 mt-1">Manages venues</div>
        </div>
        ...
        <!-- Venue -->
        <div class="bg-green-100 border-2 border-green-300 rounded-lg px-6 py-4 text-center min-w-[200px]">
          <div class="font-bold text-[14px] md:text-lg text-green-900">Venue</div>
          <div class="text-[10px] md:text-sm text-green-700 mt-1">A physical location</div>
        </div>
        ...
        <!-- Event List -->
        <div class="bg-purple-100 border-2 border-purple-300 rounded-lg px-6 py-4 text-center min-w-[200px]">
          <div class="font-bold text-[14px] md:text-lg text-purple-900">Event List</div>
          <div class="text-[10px] md:text-sm text-purple-700 mt-1">A collection of events</div>
        </div>
        ...
        <!-- Events -->
        <div class="bg-orange-100 border-2 border-orange-300 rounded-lg px-6 py-4 text-center min-w-[200px]">
          <div class="font-bold text-[14px] md:text-lg text-orange-900">Events</div>
          <div class="text-[10px] md:text-sm text-orange-700 mt-1">Individual scheduled items</div>
        </div>
      </div>
    </div>

    <div class="mt-6 space-y-4">
      <h3 class="text-[16px] md:text-xl font-semibold text-gray-900">What is an Event?</h3>
      <p>
        An <strong>event</strong> is a single scheduled item with a specific time. For example,
        a prayer service, a meeting, or a class session. Each event has:
      </p>
      ...
      <p>
        Events are grouped into <strong>event lists</strong>, which can represent a day's schedule,
        a weekly pattern, or any other logical grouping. Event lists belong to a <strong>venue</strong>,
        and venues are managed by an <strong>owner</strong>.
      </p>
    </div>
    ...
    <div class="mt-4 space-y-4">
      <div class="p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
        <p class="font-semibold text-[12px] md:text-base text-blue-900 mb-2">Timezone Set:</p>
      ...
      <div class="p-4 bg-green-50 border-l-4 border-green-500 rounded">
        <p class="font-semibold text-[12px] md:text-base text-green-900 mb-2">No Timezone Set:</p>
    ...
    <h2 class="text-[20px] md:text-2xl font-semibold mt-10 mb-4 text-gray-900">Contact</h2>
