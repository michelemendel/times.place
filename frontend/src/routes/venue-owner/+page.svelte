...
<div class="w-full min-w-0 max-w-full lg:max-w-[60%] lg:mx-auto">
  ...
  {#if owner}
    <div class="mb-2 md:mb-3 text-center">
      <div class="text-[10px] md:text-sm text-gray-700">
    ...
    <div class="mb-2 md:mb-6 flex justify-center md:justify-end">
      <button
        on:click={handleAddVenue}
        disabled={addVenueDisabled}
        class="font-semibold py-1 px-2 text-[12px] rounded-lg shadow-md transition-colors duration-200 flex items-center gap-1 md:py-3 md:px-6 md:text-base md:gap-2 {addVenueDisabled
        ...
        {#each ownerVenues as venue (venue.venue_uuid)}
          ...
          <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden flex flex-col h-full">
            ...
            <div class="p-2 md:p-6 flex flex-col flex-grow">
              ...
              <div class="flex flex-row gap-1 md:gap-2 mt-auto">
                <button
                  on:click={() => handleEditVenue(venue)}
                  class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-1 md:py-2 px-2 md:px-4 rounded-lg transition-colors duration-200 text-[10px] md:text-base"
                >
                  Edit
                </button>
                <button
                  on:click={() => handleDeleteClick(venue)}
                  class="flex-1 bg-red-600 hover:bg-red-700 text-white font-medium py-1 md:py-2 px-2 md:px-4 rounded-lg transition-colors duration-200 text-[10px] md:text-base"
                >
                  Delete
                </button>
              </div>
      ...
      <article class="bg-white rounded-xl shadow-xl max-w-md w-full p-3 md:p-6">
        ...
        <div class="flex flex-row gap-2 md:gap-3 justify-end">
          <button
            ...
            class="px-2 md:px-4 py-1 md:py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors duration-200 font-medium text-[12px] md:text-base"
          >
            Cancel
          </button>
          <button
            on:click={handleDeleteConfirm}
            class="px-2 md:px-4 py-1 md:py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition-colors duration-200 font-medium text-[12px] md:text-base"
          >
            Delete
          </button>
        </div>
